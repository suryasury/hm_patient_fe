...
const AppointmentDetails = () => {
  ...
  const fetchAppointmentDetails = async () => {
    try {
      ...
      setSelectedSlot({
        id: res.data.data.doctorSlotId,
        startTime: res.data.data.doctorSlots.slot.startTime,
        hospitalId: res.data.data.doctorSlots.slot.hospitalId,
      });
    } catch (error) {
                  ...
                  <form className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Input
                        id="ailment"
                        type="text"
                        value={appointmentDetails?.decease}
                        className="border-2 rounded-sm p-2"
                        disabled
                      />
                    </div>
                          ...
                          {appointmentDetails?.patientAppointmentDocs?.map(
                            (file, index) => (
                              <Dialog key={file.id}>
                                ...
                                <DialogContent className="max-w-[900px] max-h-[700px] min-h-[40vh] rounded-lg shadow-lg flex flex-col overflow-auto">
                                  <DialogTitle>
                                    <DialogHeader>
                                      {file.documentName}
                                    </DialogHeader>
                                  </DialogTitle>
                                  {file.documentName.split(".").pop() ===
                                  "pdf" ? (
